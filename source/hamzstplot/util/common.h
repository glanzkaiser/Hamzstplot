...
#ifndef HAMZSTPLOTPLUSPLUS_COMMON_H
#define HAMZSTPLOTPLUSPLUS_COMMON_H
...
namespace hamzstplot {
    ...
    /// The algorithm in this function is inspired by this hamzstplot script:
    ...
    class HAMZSTPLOT_EXPORTS vector_2d_view {
        using vector_2d = hamzstplot::vector_2d;
...
#endif // HAMZSTPLOTPLUSPLUS_COMMON_H
