...
#ifndef HAMZSTPLOTPLUSPLUS_COLORS_H
#define HAMZSTPLOTPLUSPLUS_COLORS_H
...
namespace hamzstplot {
    ...
    HAMZSTPLOT_EXPORTS
    std::string to_string(hamzstplot::color c);

    HAMZSTPLOT_EXPORTS
    hamzstplot::color string_to_color(std::string_view s);

    HAMZSTPLOT_EXPORTS
    hamzstplot::color char_to_color(char c);

    HAMZSTPLOT_EXPORTS
    bool is_valid_color_char(char c);

    HAMZSTPLOT_EXPORTS
    std::array<float, 4> to_array(hamzstplot::color c);
...
#endif // HAMZSTPLOTPLUSPLUS_COLORS_H
