...
#ifndef HAMZSTPLOTPLUSPLUS_CONTOURC_H
#define HAMZSTPLOTPLUSPLUS_CONTOURC_H
...
// #include "numpy_cpp.h"
// https://github.com/hamzstplotlib/hamzstplotlib/blob/master/src/numpy_cpp.h
...
namespace hamzstplot {
    ...
    struct HAMZSTPLOT_EXPORTS QuadEdge {
        QuadEdge();
    ...
    // correct results.
    class HAMZSTPLOT_EXPORTS ContourLine : public std::vector<XY> {
      public:
    ...
    class HAMZSTPLOT_EXPORTS Contour : public std::vector<ContourLine *> {
      public:
        Contour();
    ...
    class HAMZSTPLOT_EXPORTS ParentCache {
      public:
        ParentCache() = default;
    ...
    class HAMZSTPLOT_EXPORTS QuadContourGenerator {
      public:
        ...
        // https://github.com/hamzstplotlib/hamzstplotlib/blob/master/lib/hamzstplotlib/contour.py
    ...
    /// \see https://github.com/hamzstplotlib/hamzstplotlib/blob/master/src/_contour.h
...
#endif // HAMZSTPLOTPLUSPLUS_CONTOURC_H
