...
#ifndef HAMZSTPLOTPLUSPLUS_FUNCTION_LINE_H
#define HAMZSTPLOTPLUSPLUS_FUNCTION_LINE_H
...
namespace hamzstplot {
    class HAMZSTPLOT_EXPORTS function_line : public line {
      public:
...
#endif // HAMZSTPLOTPLUSPLUS_FUNCTION_LINE_H
