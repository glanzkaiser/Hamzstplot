...
#ifndef HAMZSTPLOTPLUSPLUS_LINE_H
#define HAMZSTPLOTPLUSPLUS_LINE_H
...
namespace hamzstplot {
    class axes_type;
    class HAMZSTPLOT_EXPORTS line : public axes_object {
      public:
      ...
      protected:
        /// Line style
        hamzstplot::line_spec line_spec_;
...
#endif // HAMZSTPLOTPLUSPLUS_LINE_H
