...
#ifndef HAMZSTPLOTPLUSPLUS_FILLED_AREA_H
#define HAMZSTPLOTPLUSPLUS_FILLED_AREA_H
...
namespace hamzstplot {
    ...
    class HAMZSTPLOT_EXPORTS filled_area : public line {
      public:
...
#endif // HAMZSTPLOTPLUSPLUS_FILLED_AREA_H
