...
#ifndef HAMZSTPLOTPLUSPLUS_CIRCLES_H
#define HAMZSTPLOTPLUSPLUS_CIRCLES_H
...
namespace hamzstplot {
    class axes_type;
    class HAMZSTPLOT_EXPORTS circles : public axes_object {
      public:
...
#endif // HAMZSTPLOTPLUSPLUS_CIRCLES_H
