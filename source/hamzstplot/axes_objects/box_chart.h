...
#ifndef HAMZSTPLOTPLUSPLUS_BOX_CHART_H
#define HAMZSTPLOTPLUSPLUS_BOX_CHART_H
...
namespace hamzstplot {
    class axes_type;
    class HAMZSTPLOT_EXPORTS box_chart : public axes_object {
      public:
...
#endif // HAMZSTPLOTPLUSPLUS_BOX_CHART_H
