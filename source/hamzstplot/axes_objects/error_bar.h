...
#ifndef HAMZSTPLOTPLUSPLUS_ERROR_BAR_H
#define HAMZSTPLOTPLUSPLUS_ERROR_BAR_H
...
namespace hamzstplot {
    ...
    class HAMZSTPLOT_EXPORTS error_bar : public line {
      public:
...
#endif // HAMZSTPLOTPLUSPLUS_ERROR_BAR_H
