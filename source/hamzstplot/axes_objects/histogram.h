...
#ifndef HAMZSTPLOTPLUSPLUS_HISTOGRAM_H
#define HAMZSTPLOTPLUSPLUS_HISTOGRAM_H
...
namespace hamzstplot {
    class axes_type;
    class HAMZSTPLOT_EXPORTS histogram : public axes_object {
      public:
...
#endif // HAMZSTPLOTPLUSPLUS_HISTOGRAM_H
