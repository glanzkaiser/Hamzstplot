...
#ifndef HAMZSTPLOTPLUSPLUS_LABELS_H
#define HAMZSTPLOTPLUSPLUS_LABELS_H
...
namespace hamzstplot {
    class axes_type;
    class HAMZSTPLOT_EXPORTS labels : public axes_object {
      public:
...
#endif // HAMZSTPLOTPLUSPLUS_LABELS_H
