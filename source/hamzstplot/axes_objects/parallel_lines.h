...
#ifndef HAMZSTPLOTPLUSPLUS_PARALLEL_LINES_H
#define HAMZSTPLOTPLUSPLUS_PARALLEL_LINES_H

#include <hamzstplot/detail/config.h>
#include <hamzstplot/core/figure_type.h>
#include <hamzstplot/core/axes_object.h>
...
namespace hamzstplot {
    class axes_type;
    class HAMZSTPLOT_EXPORTS parallel_lines : public axes_object {
      public:
      ...
      public /* getters and setters */:
        const hamzstplot::line_spec &line_spec() const;
        class parallel_lines &line_spec(const hamzstplot::line_spec &line_spec);
...
#endif // HAMZSTPLOTPLUSPLUS_PARALLEL_LINES_H
