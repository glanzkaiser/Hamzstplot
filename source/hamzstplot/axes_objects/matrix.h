...
#ifndef HAMZSTPLOTPLUSPLUS_MATRIX_H
#define HAMZSTPLOTPLUSPLUS_MATRIX_H
...
namespace hamzstplot {
    ...
    class HAMZSTPLOT_EXPORTS matrix : public axes_object {
      public:
...
#endif // HAMZSTPLOTPLUSPLUS_MATRIX_H
