...
#ifndef HAMZSTPLOTPLUSPLUS_NETWORK_H
#define HAMZSTPLOTPLUSPLUS_NETWORK_H
...
namespace hamzstplot {
    class axes_type;
    class HAMZSTPLOT_EXPORTS network : public axes_object {
      public:
...
#endif // HAMZSTPLOTPLUSPLUS_NETWORK_H
