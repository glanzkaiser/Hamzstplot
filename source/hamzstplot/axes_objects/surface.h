...
#ifndef HAMZSTPLOTPLUSPLUS_SURFACE_H
#define HAMZSTPLOTPLUSPLUS_SURFACE_H
...
namespace hamzstplot {
    ...
    /// 2d
    class HAMZSTPLOT_EXPORTS surface : public axes_object {
      public:
...
#endif // HAMZSTPLOTPLUSPLUS_SURFACE_H
