...
#ifndef HAMZSTPLOTPLUSPLUS_VECTORS_H
#define HAMZSTPLOTPLUSPLUS_VECTORS_H
...
namespace hamzstplot {
    class axes_type;
    class HAMZSTPLOT_EXPORTS vectors : public axes_object {
      public:
...
#endif // HAMZSTPLOTPLUSPLUS_VECTORS_H
