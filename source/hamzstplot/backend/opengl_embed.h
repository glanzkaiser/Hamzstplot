...
#ifndef HAMZSTPLOTPLUSPLUS_OPENGL_EMBED_H
#define HAMZSTPLOTPLUSPLUS_OPENGL_EMBED_H
...
namespace hamzstplot::backend {
    class HAMZSTPLOT_EXPORTS opengl_embed : public backend_interface {
      public:
        opengl_embed();
...
#endif // HAMZSTPLOTPLUSPLUS_OPENGL_EMBED_H
