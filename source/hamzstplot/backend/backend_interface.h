...
#ifndef HAMZSTPLOTPLUSPLUS_BACKEND_INTERFACE_H
#define HAMZSTPLOTPLUSPLUS_BACKEND_INTERFACE_H
...
namespace hamzstplot {
    ...
    namespace backend {
        ...
        /// https://github.com/hamzstplotlib/hamzstplotlib/blob/master/src/_backend_agg.h
        ...
        class HAMZSTPLOT_EXPORTS backend_interface {
          ...
          public:
            ...
            virtual void show(hamzstplot::figure_type *);
...
#endif // HAMZSTPLOTPLUSPLUS_BACKEND_INTERFACE_H
