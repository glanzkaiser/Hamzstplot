...
#ifndef HAMZSTPLOTPLUSPLUS_BACKEND_GNUPLOT_H
#define HAMZSTPLOTPLUSPLUS_BACKEND_GNUPLOT_H

#include <hamzstplot/detail/config.h>
#include <hamzstplot/backend/backend_interface.h>
#include <hamzstplot/util/popen.h>
#include <array>
#include <chrono>
#include <tuple>

namespace hamzstplot::backend {
    class HAMZSTPLOT_EXPORTS gnuplot : public backend_interface {
      public:
        gnuplot();
        virtual ~gnuplot();
    ...
    !defined(HAMZSTPLOT_BUILD_FOR_DOCUMENTATION_IMAGES)
...
#endif // HAMZSTPLOTPLUSPLUS_BACKEND_GNUPLOT_H
