#ifndef HAMZSTPLOTPLUSPLUS_FIGURE_TYPE_H
#define HAMZSTPLOTPLUSPLUS_FIGURE_TYPE_H
...
namespace hamzstplot {
    ...
    class HAMZSTPLOT_EXPORTS figure_type {
      public:
...
#endif // HAMZSTPLOTPLUSPLUS_FIGURE_TYPE_H
