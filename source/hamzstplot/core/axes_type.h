...
#ifndef HAMZSTPLOTPLUSPLUS_AXES_TYPE_H
#define HAMZSTPLOTPLUSPLUS_AXES_TYPE_H

#include <hamzstplot/detail/config.h>

#include <hamzstplot/util/colors.h>
#include <hamzstplot/util/handle_types.h>
#include <hamzstplot/util/keywords.h>

#include <hamzstplot/core/axis_type.h>
#include <hamzstplot/core/legend.h>
...
namespace hamzstplot {
    class HAMZSTPLOT_EXPORTS axes_type : public std::enable_shared_from_this<class axes_type> {
      public:
...
#endif // HAMZSTPLOTPLUSPLUS_AXES_TYPE_H
