...
#ifndef HAMZSTPLOTPLUSPLUS_CHARTOBJECT_H
#define HAMZSTPLOTPLUSPLUS_CHARTOBJECT_H
...
namespace hamzstplot {
    ...
    class HAMZSTPLOT_EXPORTS axes_object {
      public:
...
#endif // HAMZSTPLOTPLUSPLUS_CHARTOBJECT_H
